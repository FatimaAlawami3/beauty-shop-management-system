...
CREATE TABLE `manger` (
  `mfname` varchar(55) DEFAULT NULL,
  `mlname` varchar(55) DEFAULT NULL,
  `SSN` int NOT NULL,
  `SEX` varchar(55) DEFAULT NULL,
  `M_PASSWORD` varchar(55) DEFAULT NULL,
  `ADDRESS` varchar(55) DEFAULT NULL,
  `SALARY` int DEFAULT NULL,
  `CONTACTNUM` int DEFAULT NULL,
  `BIRTHDATE` varchar(55) DEFAULT NULL,
  PRIMARY KEY (`SSN`)
...
INSERT INTO `manger` VALUES ('asd','as',1,'fe','h,','adf',578,849,'12'),('saad','m',130,'male','1234','damam',20000,555,'12');
